...
class FaceDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        #print("hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh",path)
        if 'syn' in path:
...
def build(image_set, args):
    ...
    mode = 'instances'
    # PATHS = {
    #     "train": ( "./YCB_Video_Dataset", '/home/ai2lab/Desktop/台達計畫/T6D_implement/T6D-direct/YCB_Video_Dataset/train.json'),
