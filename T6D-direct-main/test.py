...
p3d = []
for cls in open('/home/ai2lab/Desktop/台達計畫/T6D_implement/T6D-direct/YCB_Video_Dataset/image_sets/classes.txt'):
    if '\n' in cls:
        cls = cls[:-1]
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/home/ai2lab/Desktop/台達計畫/T6D_implement/T6D-direct/checkpoint0270.pth', help='resume from checkpoint')
...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        print(outputs['pred_orien'][0, keep])
        ...
        for i , idx in enumerate(idxs):
            ...
            #rotMat = R.from_quat(orien_cpu[0, keep][i]).as_matrix()
...
if __name__ == "__main__":
    ...
    image_paths = get_images("/home/ai2lab/Desktop/台達計畫/T6D_implement/T6D-direct/00001-color.png")
