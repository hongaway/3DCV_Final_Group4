...
########################## not in detr but in deformable_detr #########################
...
class SetCriterion(nn.Module):
    ...
    """
    # def __init__(self, num_classes, matcher, weight_dict, losses, focal_alpha=0.25, cld):
...
def build(args):
    ...
    # criterion = SetCriterion(num_classes, matcher, weight_dict, losses, focal_alpha=args.focal_alpha, cld = cld) # in T6D
